...
export default {
  ...
  methods: {
    ...
    isSelected (item) {
      // console.log('555aaa', this.filters.users)
        ...
        if (this.computedUsers.length !== this.filters.users.length) {
          this.computedUsers.forEach(el => {
            if (!this.filters.users.includes(el.id)) {
              ...
              console.log('nnnnnnnnnn-this.filters.users', this.filters.users)
            }
          })
        } else {

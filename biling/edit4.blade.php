                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                            <tr style="display: flex; flex-direction: column; align-items: flex-end">
                                @if($template->unit['unittype'] == Dc_Model_UnitTypes::SERVER ||
                                    ...
                                    {{--                                    @endif--}}
                                    {{--                                    <td style="width: 20px; {{ $template->unit['virtualunit'] ? 'padding-left: 15px' : '' }}">--}}
                                    {{--                                        <a href="{{ $template->getUrlByLink('dc.spam.index', array('unitid' => $template->uid)) }}">--}}
                                    {{--                                            <img src="/Images/letter.gif" width="16" height="16" border="0" alt="{{ _('Отправить уведомление') }}"--}}
                                    {{--                                                 title="{{ _('Отправить уведомление') }}"></a>--}}
                                    {{--                                    </td>--}}
                                    {{--                                    @if(!$template->unit['archived'] ||  !$template->unit['virtualunit'])--}}
                                    {{--                                        <td width="10" align="center">&nbsp;|&nbsp;</td>--}}
                                    {{--                                    @endif--}}
                                @endif
                                @if( $template->aclIsAllowed('edit_dcunits') && (!$template->unit['archived'] || !$template->unit['virtualunit']))
                                    ...
                                    {{--                                        <img src="Images/delete.gif" alt="{{ _('Удалить (переместить в архив)') }}"--}}
                                    {{--                                                                   title="{{ _('Удалить (переместить в архив)') }}">--}}
                                    {{--                                    </a>--}}
                                    {{--                                </td>--}}

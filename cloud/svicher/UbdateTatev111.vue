...
export default {
  ...
  computed: {
    ...
    isCustomNaming() {
      ...
      console.log('hasNamingCabs', hasNamingCabs);
      console.log('this.selectedCabs', this.selectedCabs);
      console.log('this.cabsOptions1', this.cabsOptions);

  ...
  methods: {
    ...
    async startProfile () {
      ...
      try {
        ...
        if ((response.status === 200 || response.data.success === true) && response.data) {
          console.log('data.success === true')
          this.$store.dispatch('browserProfiles/setStartTime', { browserProfileId: response.data.browserProfileId, browserProfileLastStartTime: response.data.created_at })
        }
